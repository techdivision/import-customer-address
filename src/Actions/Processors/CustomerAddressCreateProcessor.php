...
/**
 * TechDivision\Import\Customer\Address\Actions\Processors\CustomerAddressCreateProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The customer address create processor implementation.
 *
 * @author     Tim Wagner <t.wagner@techdivision.com>
 ...
 */
class CustomerAddressCreateProcessor extends AbstractCreateProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            SqlStatementKeys::CREATE_CUSTOMER_ADDRESS => $this->loadStatement(SqlStatementKeys::CREATE_CUSTOMER_ADDRESS)
        );
    }
